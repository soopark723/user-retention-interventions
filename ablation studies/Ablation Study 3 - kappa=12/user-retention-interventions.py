...
kappa = 12.0         # Churn penalty - high value: Agent becomes highly risk-averse. Lower engagement, minimal fatigue, higher retention. Dominated by none/notify.
...
def encode_state(e, f, u, c):
    ...
    return np.array([
        e,
        f,
        c / 5.0,  # Normalize counter to [0, 1] range (counter max is 5)
...
policy_net = DQN(6, NUM_ACTIONS)
target_net = DQN(6, NUM_ACTIONS)
